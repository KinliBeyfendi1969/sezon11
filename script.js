...
let state = {
    apiKey: "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",
    currentUnitIndex: 0,
    currentQuestion: "",
    totalScore: 0,
    questionCount: 0,
...
async function generateQuestion() {
    ...
    const questionText = await callOpenRouter(prompt, "Sen bir Tarih öğretmenisin. Öğrencilere tarihi olayların nedenlerini, sonuçlarını ve bağlamlarını anlamalarına yardımcı olacak kolay seviye sorular hazırlarsın.Puanlama 0 ile 10 arası (0 ve 10 dahil) başlasın.");
...
async function submitAnswer() {
    ...
    Görevin:
    1. Cevabı tarihsel doğruluk, kapsam ve yeterlilik açısından 0 ile 10 arasında puanla.
